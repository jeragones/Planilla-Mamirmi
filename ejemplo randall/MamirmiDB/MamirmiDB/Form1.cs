...
namespace MamirmiDB
{
    ...
    {
        string ranguro = "Data Source=201.191.100.11\\RANGUROSERVER,1433;Initial Catalog=" + "Mamirmi's Form" + ";User ID=lesmed;Password=lesmed";
        public Form1()
        {
            InitializeComponent();
        }
        ...
        private void cargar_personas() {
            SqlConnection conn = new SqlConnection(ranguro);
            conn.Open();
